...
impl<E: PairingEngine> StandardComposer<E> {
    ...
    pub(crate) fn eval(&self, a: &Variable) -> E::Fr {
    ...
    // Helper to perform an addition without providing the output
    pub fn add(
        &mut self,
        l: Variable,
        r: Variable,
    ...
    // Helper to perform a multiplication without providing the output
    pub fn mul(
        &mut self,
        l: Variable,
        r: Variable,
