...
pub struct ProverKey {
    ...
    pub q_fixed_base: (Polynomial, Evaluations),
}
...
impl ProverKey {
    ...
    pub(crate) fn compute_quotient_i(
        ...
        let q_fixed_base_i = &self.q_fixed_base.1[index];
        ...
        identity * q_fixed_base_i * ecc_separation_challenge
    }
    ...
    pub(crate) fn compute_linearisation(
        ...
        let q_fixed_base_poly = &self.q_fixed_base.0;
        ...
        q_fixed_base_poly * &(a * ecc_separation_challenge)
    }
}
